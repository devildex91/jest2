...
class JsdomModernEnvironment extends jest_environment_jsdom_1.default {
    async setup() {
        await super.setup();
        if (this.global.TextEncoder !== undefined || // eslint-disable-line @typescript-eslint/no-unnecessary-condition
        ...
        this.global.TextDecoder = util_1.TextDecoder;
        this.global.TextEncoder = util_1.TextEncoder;
        // restore for instanceof, see https://github.com/jestjs/jest/issues/9983
        this.global.Uint8Array = Uint8Array;
        this.global.ArrayBuffer = ArrayBuffer;
    }
}
exports.default = JsdomModernEnvironment;
